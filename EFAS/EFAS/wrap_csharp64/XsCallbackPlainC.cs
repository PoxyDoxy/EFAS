...
public class XsCallbackPlainC : global::System.IDisposable {
  ...
  public SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void m_onAllBufferedDataAvailable {
    set {
      xsensdeviceapiPINVOKE.XsCallbackPlainC_m_onAllBufferedDataAvailable_set(swigCPtr, SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void m_onAllDataAvailable {
    set {
      xsensdeviceapiPINVOKE.XsCallbackPlainC_m_onAllDataAvailable_set(swigCPtr, SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void.getCPtr(value));
    } 
    get {
  ...
  public SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void m_onAllRecordedDataAvailable {
    set {
      xsensdeviceapiPINVOKE.XsCallbackPlainC_m_onAllRecordedDataAvailable_set(swigCPtr, SWIGTYPE_p_f_p_XsCallbackPlainC_p_XsDevicePtrArray_p_p_q_const__XsDataPacket__void.getCPtr(value));
    } 
    get {
